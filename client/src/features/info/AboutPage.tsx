...
export default function AboutPage() {
    ...
    return (
        <Box sx={{ bgcolor: 'background.default' }}>
            ...
            >
                <Container maxWidth="lg">
                    ...
                    >
                        ...
                        <Typography variant="h1" fontWeight={900} sx={{ color: '#fff', fontSize: { xs: '3rem', md: '5rem' } }}>
                ...
                <Grid container spacing={10} alignItems="center">
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box
                            ...
                            sx={{ width: '100%', border: '1px solid rgba(255,255,255,0.1)' }}
                        />
                    </Grid>
                </Grid>
            </Container>
            ...
            {/* Values Section */}
            <Box sx={{ py: 20, bgcolor: 'secondary.main' }}>
                <Container maxWidth="lg">
                            ...
                            <Grid size={{ xs: 12, md: 4 }} key={i}>
                                <Paper
                                    ...
                                    sx={{
                                        ...
                                        '&:hover': { transform: 'translateY(-10px)', borderColor: theme.palette.primary.main }
                                    }}
                                >
